<template>
    ...
    <div class="d-flex flex-colum px-3 h-75">
        ...
        <Fab 
        icon="fa-save"/>
        <img src="https://depor.com/resizer/-oIKYNbK6lK8_efeR6GgelLT1RM=/580x330/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/NBCFVQIOHZD4NHOIZFJMKMEI7Y.jpg" 
        alt="entry-picture"
        class="img-thumbnail">
    </div>
</template>
